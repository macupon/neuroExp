...
const formSchema = z.object({
      ...
      textarea:
        z.string(),
      type1: 
        z.enum(["NE", "SLE", "IC", "SLT"],{
          required_error: "You need to select an option.",
        }),
      type2: 
        z.enum(["0-12", "12-24", "2-3", "4-5", "OVER6"],{
          required_error: "You need to select an option.",
        }),
      type3: 
        z.enum(["SP", "EN", "DS", "OTHER"],{
          required_error: "You need to select an option.",
        }),
      // phone: 
      //   z.number()
            ...
            <div className=" flex flex-col md:flex-row md:space-x-16" >
              <FormField
                ...
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="email@..." {...field} className="w-60"/>
                  </FormControl>
                  <FormDescription>
                    Write your email.
                  </FormDescription>
              ...
              <FormControl>
                ...
                >
                  ...
                  <FormItem className="flex items-center space-x-3 space-y-0">
                    ...
                    <FormLabel className="font-normal">Speech and Language Therapy.</FormLabel>
                  </FormItem>
                </RadioGroup>
              </FormControl>
              <FormMessage />
              ...
              <FormControl>
                ...
                >
                  ...
                  <FormItem className="flex items-center space-x-3 space-y-0">
                    ...
                    <FormLabel className="font-normal">2 - 3 years old.</FormLabel>
                  </FormItem>
                  <FormItem className="flex items-center space-x-3 space-y-0">
                    <FormControl>
                      <RadioGroupItem value="4-5" />
                    </FormControl>
                    <FormLabel className="font-normal">4 - 5 years old.</FormLabel>
                  </FormItem>
                  <FormItem className="flex items-center space-x-3 space-y-0">
                    <FormControl>
                      <RadioGroupItem value="OVER6" />
                    </FormControl>
                    <FormLabel className="font-normal">Over 6 years old.</FormLabel>
                  </FormItem>
                </RadioGroup>
              </FormControl>
              <FormMessage />
...
{/* BUTTON */}
            ...
            <Button type="submit" className="md:w-[150px]">Submit</Button>
          </form>
        </Form>
      </>
      )
