  ...
  return (
    ...
    <div className="flex flex-wrap p-6 md:p-8  md:items-center lg:items-center">
      ...
      <div className='flex flex-col md:flex-row p-4 md:p-8 rounded-xl  flex justify-center  md:leading-10'>
          <h1 className='bg-sky-200 text-left font-bold w-10  md:h-24 md:mr-16  mb-6 md:mb-5 md:mt-0 md:w-24 lg:ml-12 text-4xl md:text-5xl lg:text-6xl'>WHAT WE OFFER</h1>
      ...
      <img src={babyblocks} alt="" className='m-2rounded-xl lg:w-[100%] lg:h-[400px]'/>

      <div className='flex flex-col lg:flex-col bg-white/50 p-8 rounded-xl mt-8'>
        <h2 className='mt-5 mb-5 font-bold md:ml-0 lg:ml-12 text-2xl lg:text-3xl'> Neurodevelopmental evaluation</h2>
        <div className='flex flex-col md:flex-row my-8'>
          <img src={babybear} alt="" className='md:w-[20vw] md:h-[20vh] lg:w-auto lg:h-auto md:mt-0 rounded-lg'/>
      ...
      <div className='flex flex-col lg:flex-col bg-white/50 p-8 rounded-xl mt-8'>
        <h2 className='mt-5 mb-5 font-bold md:ml-0 lg:ml-12 text-2xl lg:text-3xl'> Speech and Language Evaluation</h2>
        <div className='flex flex-col md:flex-row my-8'>
          <img src={babydough} alt="" className='md:w-[20vw] md:h-[20vh] lg:w-auto lg:h-auto md:mt-0 rounded-lg'/>
            <p className='my-5 md:my-0 leading-7 md:leading-6 lg:leading-10 md:ml-6 md:text-base lg:text-xl'>
      ...
      <div className='flex flex-col lg:flex-col bg-white/50 p-8 rounded-xl mt-8'>
        <h2 className='mt-5 mb-5 font-bold md:ml-0 lg:ml-12 text-2xl lg:text-3xl'> Initial Consultation </h2>
        <div className='flex flex-col md:flex-row my-8'>
          <img src={speechtep} alt="" className='md:w-[20vw] md:h-[20vh] lg:w-auto lg:h-auto md:mt-0 rounded-lg'/>
            <p className='my-5 md:my-0 leading-7 md:leading-6 lg:leading-10 md:ml-6 md:text-base lg:text-xl'>
      ...
      <div className='flex flex-col lg:flex-col bg-white/50 p-8 rounded-xl mt-8'>
        <h2 className='mt-5 mb-5 font-bold md:ml-0 lg:ml-12 text-2xl lg:text-3xl'> Language Therapy</h2>
        <div className='flex flex-col md:flex-row my-8'>
          <img src={speechterap} alt="" className='md:w-[20vw] md:h-[20vh] lg:w-auto lg:h-auto md:mt-0 rounded-lg'/>
            <p className='my-5 md:my-0 leading-7 md:leading-6 lg:leading-10 md:ml-6 md:text-base lg:text-xl'>
